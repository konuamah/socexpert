    ...
    <div className="grid lg:grid-cols-2 divide-y lg:divide-y-0">
      ...
      >
        <header className="text-center mb-10">
          ...
          <h2 id="mission-heading" className="text-4xl font-light text-blue-600 mb-4">
            Mission
          </h2>
          <hr className="w-16 mx-auto border-0 h-0.5 bg-gradient-to-r from-blue-500 to-indigo-600" />
        </header>
      ...
      >
        <header className="text-center mb-10">
          ...
          <h2 id="vision-heading" className="text-4xl font-light text-blue-600 mb-4">
            Vision
          </h2>
          <hr className="w-16 mx-auto border-0 h-0.5 bg-gradient-to-r from-purple-500 to-pink-600" />
        </header>
        <p className="text-gray-700 leading-relaxed text-xl font-light text-center">
